...
public class GlobalConfig : MonoBehaviour
{
    ...
    private void Start()
    {
        if(PlayerPrefs.GetInt(GameDefine.is_first_opened, 0) == 0)
        {
            ...
            UpdateCoin(RemoteConfig.instance.StartCoin);
        }
    ...
    private void SetUpNotification()
    {
        if(PlayerPrefs.GetInt(GameDefine.is_set_up_notification, 0) == 0)
        {
            ...
            GleyNotifications.SendNotification("Color ASMR!", "Let's color Skibidi Toilet", new System.TimeSpan(1,0,0,0), "icon_1", "icon_0");
            GleyNotifications.SendNotification("Color ASMR!", "Let's color Skibidi Toilet", new System.TimeSpan(3, 0, 0, 0), "icon_1", "icon_0");
            GleyNotifications.SendNotification("Color ASMR!", "Let's color Skibidi Toilet", new System.TimeSpan(6, 0, 0, 0), "icon_1", "icon_0");
            GleyNotifications.SendNotification("Color ASMR!", "Let's color Skibidi Toilet", new System.TimeSpan(9, 0, 0, 0), "icon_1", "icon_0");
